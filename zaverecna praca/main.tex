...
\begin{titlepage}
	\begin{center}
		...
		% RP: Dal by som ``Modelovanie, dynamika a odhad parametrov biochemických reaktorov''
		...
		\vfill
		\begin{flushleft}
		% RP: Zrusil by som ten flushleft. Zda sa mi to rusive ak je to len jeden riadok z celej strany.
			\large
...
\subsection{Dynamika}
\input{content/ssec_dynamics}

\subsection{Stabilita}
\input{content/ssec_stability}
...
\input{content/ssec_opt_methods}

\subsection{Prístupy k odhadu}
\input{content/ssec_approx_methods}

\section{Výsledky}
\input{content/ssec_results}

\section{Záver}
\input{content/ssec_conclusion}
